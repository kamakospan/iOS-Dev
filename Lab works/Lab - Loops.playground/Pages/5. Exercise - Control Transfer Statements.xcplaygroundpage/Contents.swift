...
var capitals: [String : String] = ["Washington":"Olympia", "Oregon":"Portland", "California":"Sacramento", "Atyrau obl":"Atyrau city"]

for (state, cap) in capitals {
    print("\(state)'s capital is \(cap)")
