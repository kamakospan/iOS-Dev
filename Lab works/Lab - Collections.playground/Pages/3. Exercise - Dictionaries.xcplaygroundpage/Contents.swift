...
if let januaryColors = colorsArray["January"] {
    if !januaryColors.isEmpty {
        print("Last color of January: \(januaryColors[januaryColors.count - 1])")
    } else {
        print("No colors available for January")
    }
} else {
    print("Colors for January not found in the dictionary")
}
