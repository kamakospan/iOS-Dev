...
// print(falcon.weapon)
print("it's impossible to call weapon on falcon because falcon is the instance of the parent class. EVen tho child class can inherit and have all the fields from the parent, it doesnt work like that both ways")
