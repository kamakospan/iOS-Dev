...
struct User {
    ...
    static var curUser: User = User(userName: "kamakospan", email: "kamakospan@gmail.com", age: 19)
    
    static func login(user: User) {
        curUser = user
        print("\(curUser.userName) has logged in")
    }
}

print(User.curUser.userName)
/*:
 ...
 */
let anotherUser = User(userName: "Dianakual", email: "dianakual@gmail.com", age: 22)
