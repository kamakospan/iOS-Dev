...
var faveBook = Book(title: "Abay zholy", author: "Auezov", pages: 5000, price: 6990)
...
struct Laptop {
    ...
    init(scrSize: Int = 13, repairCnt: Int = 0, yearPurchased: Int) {
        self.scrSize = scrSize
        self.repairCnt = repairCnt
        self.yearPurchased = yearPurchased
    }
}

var favLaptop = Laptop(yearPurchased: 2020)
print(favLaptop.repairCnt, favLaptop.scrSize, favLaptop.yearPurchased)

var jstLaptop = Laptop(yearPurchased: 2024)
print(jstLaptop.repairCnt, jstLaptop.scrSize, jstLaptop.yearPurchased)
...
struct Height {
    ...
    var heightCms: Double
    
    init(hInInches: Double) {
        self.heightInches = hInInches
        self.heightCms = hInInches * 2.54
    }
    
    init(hInCm: Double) {
        self.heightCms = hInCm
        self.heightInches = hInCm / 2.54
...
var someonesHeight = Height(hInInches: 65)
print(someonesHeight.heightCms)
