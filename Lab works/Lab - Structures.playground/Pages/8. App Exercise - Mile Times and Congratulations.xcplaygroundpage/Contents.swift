...
struct RunningWorkout {
    ...
    var avgMileTime: Double {
        var mileTotal = distance / 1600
        var avgTime = time / mileTotal
        return avgTime
    }
}

var myRun = RunningWorkout(distance: 25000, time: 60, elevation: 6)
print(myRun.avgMileTime)
...
var Dilnaz = Steps(steps: 9999, goal: 10000)
print(Dilnaz.steps)
Dilnaz.takeStep()
